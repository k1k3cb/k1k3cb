...
<h3 align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Montserrat&weight=600&size=24&pause=1000&color=3B82F6&center=true&vCenter=true&multiline=true&width=700&height=100&lines=Full+Stack+Developer+%F0%9F%92%BB;AI-powered+apps+%F0%9F%A4%96;RAG+%C2%B7+LLMs+%C2%B7+AI+Agents+%F0%9F%9A%80;From+Vigo%2C+Spain+%F0%9F%87%AA%F0%9F%87%B8" alt="Typing SVG" />
  </a>
</h3>
...
- 🤖 **Construyo** aplicaciones full-stack con IA integrada (RAG, asistentes, multi-tenant).
- 🧠 **Aprendiendo** agentic workflows, embeddings avanzadas y vector search a escala.
- 📊 **Interesado en** LLM apps, RAG, AI Agents, MLOps y Cloud AI.
- 🎯 **Disponible para** colaboraciones en proyectos AI / full-stack.
- 💼 **Stack principal:** TypeScript · React · Next.js · NestJS · FastAPI · PostgreSQL.
...
[![SQLModel](https://img.shields.io/badge/SQLModel-3B82F6?style=for-the-badge&logo=fastapi&logoColor=white)](https://sqlmodel.tiangolo.com/)
...
- 🤖 **AI Agents** y agentic workflows
- 📱 **React Native** para apps móviles con IA integrada
- ☁️ **MLOps** y despliegue de modelos en producción
- 🔍 **Vector databases** & semantic search a escala
